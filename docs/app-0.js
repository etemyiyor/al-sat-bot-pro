...
const PRESETS={crypto:['BTCUSDT','ETHUSDT','BNBUSDT','SOLUSDT','XRPUSDT','ADAUSDT','DOGEUSDT','LINKUSDT'],bist:['XU100','THYAO','ASELS','TUPRS','FROTO','GARAN','EREGL','KCHOL','BIMAS'],us:['AAPL','MSFT','NVDA','AMZN','GOOGL','META','TSLA','AMD']};
